...
public class AppleBatMinion extends FlxSprite {
   ...
   private int _jumpPower,mode;
	...
	public AppleBatMinion(){
		...
		//       acceleration.y = 500;
        loadGraphic("apple.png", true, true, 16, 16);      
    ...
    @Override
    public AppleBatMinion(int x, int y, int width, int height, int Mode) {
        super(width, height);
        this.x = x;
        this.y = y;
        int runSpeed = 50;
